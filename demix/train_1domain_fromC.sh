...
mkdir -p ${SERIALIZATION_DIR}/unbalanced_dense_${NUM_GPUS}_GPUs_${ARCH}_${FILE_SUFFIX}
cp ${COPY_PATH} ${SERIALIZATION_DIR}/unbalanced_dense_${NUM_GPUS}_GPUs_${ARCH}_${FILE_SUFFIX}/checkpoint_last.pt
ls ${SERIALIZATION_DIR}/unbalanced_dense_${NUM_GPUS}_GPUs_${ARCH}_${FILE_SUFFIX}/
echo "Copied checkpoint from (${COPY_PATH}) to (${SERIALIZATION_DIR}/unbalanced_dense_${NUM_GPUS}_GPUs_${ARCH}_${FILE_SUFFIX}/checkpoint_last.pt)"
...
if [[ $ARCH == *"gpt3_small"* ]]; then
     ...
     if [[ $FILE_SUFFIX == *"TK"* ]]; then    
          ...
          SAVE_INTERVAL_UPDATES=1000;
          VALIDATION_INTERVAL=1000;
          TASK_NAME=multidomain_language_modeling_IRL;
          ...
          # SAVE_INTERVAL_UPDATES=100;
          # VALIDATION_INTERVAL=100;
          TASK_NAME=multidomain_language_modeling_HL;
     fi;
fi;
