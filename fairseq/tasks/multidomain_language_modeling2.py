...
@register_task("multidomain_language_modeling_IRL", dataclass=MultidomainLanguageModelingConfig)
class MultidomainLanguageModelingTask_IRL(LegacyFairseqTask):
    """
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        """
        train_domains, eval_domains, data_path = MultidomainLanguageModelingTask_IRL._get_domains(self.args, epoch)
